...
from PySide6.QtWidgets import (
    ...
    QComboBox, QCheckBox, QTableView, QHeaderView, QDialog, QCheckBox as QCheckBoxDialog, QDialogButtonBox, QLabel
)
...
class TicketsTab(BaseTab):
    def __init__(self, engine, tables, parent=None):
        ...
        # Таблица для отображения структуры
    ...
    def show_add_column_dialog(self):
        ...
        check_not_null = QCheckBoxDialog("NOT NULL")
        check_unique = QCheckBoxDialog("UNIQUE")
        check_foreign = QCheckBoxDialog("FOREIGN KEY")
        check_check = QCheckBoxDialog("CHECK")
    ...
    def add_ticket(self):
        ...
        if not self.seat_number_edit.text():
            QMessageBox.warning(self, "Ввод", "Необходимо ввести номер места")
            return
